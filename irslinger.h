...
static inline void addMark(uint32_t outPin, unsigned long frequency, double dutyCycle, unsigned long duration, gpioPulse_t *irSignal, unsigned int *pulseCount)
{
  //printf("Mark   %d\n", duration);
...
static inline void addSpace(uint32_t outPin, unsigned long duration, gpioPulse_t *irSignal, unsigned int *pulseCount)
{
  //printf("Space  %d\n", duration);
